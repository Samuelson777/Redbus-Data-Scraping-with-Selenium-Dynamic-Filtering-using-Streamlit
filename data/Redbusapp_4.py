...
lists_A = pd.read_csv(r"data\df_a1.csv")["Route_name"].tolist()
lists_A = pd.read_csv(r"data\df_a1.csv")["Route_name"].tolist()
lists_A = pd.read_csv(r"data\df_a1.csv")["Route_name"].tolist()
lists_T = pd.read_csv(r"data\df_t2.csv")["Route_name"].tolist()
lists_k = pd.read_csv(r"data\df_k3.csv")["Route_name"].tolist()
lists_SB = pd.read_csv(r"data\df_s4.csv")["Route_name"].tolist()
lists_W = pd.read_csv(r"data\df_w5.csv")["Route_name"].tolist()
lists_b = pd.read_csv(r"data\df_b6.csv")["Route_name"].tolist()
lists_H = pd.read_csv(r"data\df_h7.csv")["Route_name"].tolist()
lists_R = pd.read_csv(r"data\df_r8.csv")["Route_name"].tolist()
lists_P = pd.read_csv(r"data\df_p9.csv")["Route_name"].tolist()
lists_AS = pd.read_csv(r"data\df_as10.csv")["Route_name"].tolist()
...
# 7. Home Page
if web == "Home":
    st.image(r"data\Red.jpg", width=200)
