...
lists_A = pd.read_csv(r"F:\Education and Job\Guvi\Redbus_M\Scraping_1\df_a1.csv")["Route_name"].tolist()
lists_T = pd.read_csv(r"F:\Education and Job\Guvi\Redbus_M\Scraping_1\df_t2.csv")["Route_name"].tolist()
lists_k = pd.read_csv(r"F:\Education and Job\Guvi\Redbus_M\Scraping_1\df_k3.csv")["Route_name"].tolist()
lists_SB = pd.read_csv(r"F:\Education and Job\Guvi\Redbus_M\Scraping_1\df_s4.csv")["Route_name"].tolist()
lists_W = pd.read_csv(r"F:\Education and Job\Guvi\Redbus_M\Scraping_1\df_w5.csv")["Route_name"].tolist()
lists_b = pd.read_csv(r"F:\Education and Job\Guvi\Redbus_M\Scraping_1\df_b6.csv")["Route_name"].tolist()
lists_H = pd.read_csv(r"F:\Education and Job\Guvi\Redbus_M\Scraping_1\df_h7.csv")["Route_name"].tolist()
lists_R = pd.read_csv(r"F:\Education and Job\Guvi\Redbus_M\Scraping_1\df_r8.csv")["Route_name"].tolist()
lists_P = pd.read_csv(r"F:\Education and Job\Guvi\Redbus_M\Scraping_1\df_p9.csv")["Route_name"].tolist()
lists_AS = pd.read_csv(r"F:\Education and Job\Guvi\Redbus_M\Scraping_1\df_as10.csv")["Route_name"].tolist()
...
# 7. Home Page
if web == "Home":
    st.image(r"F:\Education and Job\Guvi\Redbus_M\Red.jpg", width=200)
