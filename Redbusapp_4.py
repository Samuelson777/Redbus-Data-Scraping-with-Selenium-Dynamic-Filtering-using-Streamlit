...
if web == "📍States and Routes":
    ...
    def type_and_fare_selected_route(bus_type, min_fare, max_fare, rating, start_time):
        with psycopg2.connect(host="aws-0-ap-south-1.pooler.supabase.com", user="postgres.iwqhizifnkwkrpmcypgk", password="Gsam100@#$%",port="6543", database="Redbusdb") as conn:
